    ...
    methods: {
      ...
      bindElementEvents: function () {
        ...
        if (!me.bindElementEvent) {
          ...
          if (!$(me.element).data('vue-hover')) {
            $(me.element).data('vue-hover', true);
            $(me.element).bind('mouseover', function (event) {
              me.$emit('mouseover', event, me);
            });
            $(me.element).bind('mouseout', function (event) {
              me.$emit('mouseout', event, me);
            });
          }
        }
      },
